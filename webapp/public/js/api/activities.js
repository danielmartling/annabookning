...
export async function updateActivityAbout(id, activity) {
    try {
        const response = await fetch(`/api/activities/about/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export async function updateActivityGeometry(id, lng, lat) {
    try {
        console.log(id)
        const response = await fetch(`/api/activities/geometry/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
